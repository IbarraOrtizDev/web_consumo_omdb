export class ListMovies extends HTMLElement{
    ...
    click(event, id){
        ...
        if(img === null){
            ...
            const verImagen = new CustomEvent("ver-imagen", {
                detail:img,
                composed:true,
                bubbles:true
            })
            this.dispatchEvent(verImagen)
        }
    }
